...
* The original package name 'fr.redby.gallery.pictures.pictures-service' is invalid and this project uses 'fr.redby.gallery.pictures.pictures_service' instead.
